...
function Footer({length}) {
  ...
  return (
    <Container style={{display:eixoY/tela > 0.6?'none':'block'}}>
        <ul>
            <li onClick={()=>setFooterSetor(true)}><span> Filtar por Setor </span></li>
            <li onClick={()=>setFooterNome(true)}><span> Filtar por Nome </span></li>
            <li onClick={()=>setFooterStatus(true)}><span> Filtrar por Status </span></li>
