...
import { Modal, ButtonSave, Container } from "./styled.js";
...
export default function CustomizedTables() {
  ...
  const handleSubmit = () => {
    localStorage.setItem("teste", JSON.stringify("pablo"));
  };
              ...
              <div className="formwrap">
                ...
                <input
                  onChange={(e) =>
                    setData([
                      data[0],
                      { ...data[1], [e.target.name]: e.target.value },
                      data[2],
                      data[3],
                    ])
                  }
                ...
                <input
                  onChange={(e) =>
                    setData([
                      data[0],
                      data[1],
                      { ...data[2], [e.target.name]: e.target.value },
                      data[3],
                    ])
                  }
                  type="number"
                ...
                <input
                  onChange={(e) =>
                    setData([
                      ...
                      data[1],
                      data[2],
                      { ...data[3], [e.target.name]: e.target.value },
                    ])
                  }
                  type="number"
                  name={setor}
